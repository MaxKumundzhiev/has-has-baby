"""
Implement max heap data structure with following operations:
1. add value to heap
2. peek max element
...
class MaxHeap:
    ...
    def shiftUp(self, idx: int):
        ...
        Notes:
            ...
            2. Check condition parentValue < currentValue (for MaxHeap, meaning, shift up grater value)
    ...
    def shiftDown(self, idx):
        ...
        if leftExists and not rightExists:
            ...
            # for MaxHeap we need to shift down to gratest value between left and right
