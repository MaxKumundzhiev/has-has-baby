...
conceptual:
    ...
    дополнительно, в силу того, что нам нужно будет изменять начальный борд также, мы введем доп флаг - swap.
    также, имея ввиду, по условию, острова, которые касаются краев - невалидные - нам их нужно детектирвоать.
    для этого, сначала пройдемся по крайним линиям нашего борда (с флагом swap=false) - таким образом мы найдем непригодные острова и пометим их в массиве visited. уже после, мы пойдем по внутренниму борду, с флагом swap=true.
